...
rule PANTF_TFgroup_aggregator_rawFPanalysis:
    input:
    ...
    output:
        "{path}footprints/operations/groups/{mergedsample}.rawFPanalysis.allgroups.done"
    shell:
        "touch {output}"
...
rule rawFPanalysis_COAD_MRs:
    input:
        '{path}footprints/operations/raw/{mergedsample}.TCF7.rawFPanalysis.bamcopy1.done',
        '{path}footprints/operations/raw/{mergedsample}.MNX1.rawFPanalysis.bamcopy2.done',
        '{path}footprints/operations/raw/{mergedsample}.POU5F1B.rawFPanalysis.bamcopy3.done',
        '{path}footprints/operations/raw/{mergedsample}.ESRRA.rawFPanalysis.bamcopy4.done',
        '{path}footprints/operations/raw/{mergedsample}.CDX2.rawFPanalysis.bamcopy5.done',
        '{path}footprints/operations/raw/{mergedsample}.HNF4A.rawFPanalysis.bamcopy6.done',
        '{path}footprints/operations/raw/{mergedsample}.GMEB2.rawFPanalysis.bamcopy7.done',
        '{path}footprints/operations/raw/{mergedsample}.HOXA3.rawFPanalysis.bamcopy8.done',
        '{path}footprints/operations/raw/{mergedsample}.OVOL1.rawFPanalysis.bamcopy9.done',
        '{path}footprints/operations/raw/{mergedsample}.ASCL2.rawFPanalysis.bamcopy10.done',
        '{path}footprints/operations/raw/{mergedsample}.ZSWIM1.rawFPanalysis.bamcopy11.done',
        '{path}footprints/operations/raw/{mergedsample}.CBFA2T2.rawFPanalysis.bamcopy12.done',
        '{path}footprints/operations/raw/{mergedsample}.PAX6.rawFPanalysis.bamcopy13.done',
        '{path}footprints/operations/raw/{mergedsample}.ADNP.rawFPanalysis.bamcopy14.done',
        '{path}footprints/operations/raw/{mergedsample}.TAF4.rawFPanalysis.bamcopy15.done',
        '{path}footprints/operations/raw/{mergedsample}.ZMYND8.rawFPanalysis.bamcopy16.done',
        '{path}footprints/operations/raw/{mergedsample}.ZNF696.rawFPanalysis.bamcopy17.done'
    output:
        '{path}footprints/operations/groups/{mergedsample}.rawFPanalysis.COADMR.done'
    shell:
        'touch {output}'
