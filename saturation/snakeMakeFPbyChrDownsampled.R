...
sample_prob <- snakemake@wildcards[["prob"]]
sample_rep <- snakemake@wildcards[["repnum"]]
sample_reptot <-snakemake@wildcards[["reptot"]]
...
for (a in 1:num_motif){ # An iterator for each unique motif for this gene
  ...
  #
  signalpath <- paste0(sample_path, "saturation/footprints/data/bychr/", samplename, "-REP", sample_rep, "of", sample_reptot, ".", sample_prob, ".", genename, ".", "motif", a, ".", current_chr, ".Rdata")
